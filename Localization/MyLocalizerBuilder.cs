...
public class MyLocalizerBuilder
{
    ...
    public MyLocalizerBuilder SetDefaultStringResourcesFileName(string fileName)
    {
        this.defaultStringResourcesFileName = fileName;
        return this;
    }

    public MyLocalizerBuilder SetStringResourcesFileXPath(string xPath)
    {
        this.stringResourcesFileXPath = xPath;
        return this;
    }

    public MyLocalizerBuilder SetLogger(ILogger<Localizer> logger)
    {
        this.logger = logger;
        return this;
    }

    public MyLocalizerBuilder AddStringResourcesFolderForLanguageDictionaries(
    ...
    public MyLocalizerBuilder AddPriResourcesForLanguageDictionaries(
        string[] languages,
    ...
    public MyLocalizerBuilder AddLanguageDictionary(LanguageDictionary dictionary)
    {
        this.builderActions.Add(() => this.languageDictionaries.Add(dictionary));
        return this;
    }

    public MyLocalizerBuilder AddLocalizationAction(LocalizationActions.ActionItem item)
    {
        this.localizationActions.Add(item);
        return this;
    }

    public MyLocalizerBuilder SetOptions(Action<Localizer.Options>? options)
    {
